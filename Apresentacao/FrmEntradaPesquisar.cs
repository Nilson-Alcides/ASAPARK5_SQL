...
{
    public partial class FrmEntradaPesquisar : Form
    {

        public EntradaSaida EntradaSaidaSelecionada { get; set; }
        public FrmEntradaPesquisar()
        {
            InitializeComponent();
        ...
        private void btnPesquisar_Click(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(txtPesquisar.Text, out codigoDigitado) == true)
            {
                ...
                entradaSaidaColecao = entradaSaidaNegocios.Consultar(codigoDigitado, null);
            }
            else
            {
                //Não converteu // o usuario digitou um texto
                entradaSaidaColecao = entradaSaidaNegocios.Consultar(null, txtPesquisar.Text);
            }

            dgwPrincipal.DataSource = null;
            dgwPrincipal.DataSource = entradaSaidaColecao;
            ...
            {
                MessageBox.Show("Menhuma pessoa física localizada");
            }
        }
        ...
        private void btnCadastrar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                EntradaSaidaSelecionada = dgwPrincipal.SelectedRows[0].DataBoundItem as EntradaSaida;
                DialogResult = System.Windows.Forms.DialogResult.OK;
            }
            catch (Exception ex)
            {

                MessageBox.Show(" O Grid esta vazio ");//+ ex.Message);
            }
