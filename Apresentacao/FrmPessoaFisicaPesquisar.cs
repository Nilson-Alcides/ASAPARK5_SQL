...
{
    public partial class FrmPessoaFisicaPesquisar : Form
    {
        public PessoaFisica PessoaFisicaSelecionada { get; set; }

        public FrmPessoaFisicaPesquisar()
        {
            InitializeComponent();
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(txtPesquisar.Text, out codigoDigitado) == true)
            {
                ...
                pessoaFisicaColecao = pessoaFisicaNegocios.ConsultarCodigoNome(codigoDigitado, null);
            }
            else
            {
                //Não converteu // o usuario digitou um texto
                pessoaFisicaColecao = pessoaFisicaNegocios.ConsultarCodigoNome(null, txtPesquisar.Text);
            }

            dgwPrincipal.DataSource = null;
            dgwPrincipal.DataSource = pessoaFisicaColecao;
        ...
        private void btnSelecionar_Click(object sender, EventArgs e)
        {
            ...
            PessoaFisicaSelecionada = dgwPrincipal.SelectedRows[0].DataBoundItem as PessoaFisica;
